    ...
    <div class="page-container">
      ...
      <div class="quick-links">
        ...
        <div class="links-grid">
          ...
          <a routerLink="/ongoing-projects" class="quick-link-card card">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" style="width:44px">
            ...
            <div class="link-title">Ongoing Projects</div>
          </a>
